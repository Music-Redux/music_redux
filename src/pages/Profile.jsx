    ...
    <>
      <MDBRow className=" h-100">
          ...
          <MDBCard className="bg-gray-400">
            ...
            >
              ...
              <div className="ms-3" style={{ marginTop: "130px" }}>
                <MDBTypography tag="h5" className="text-3xl">
                  {user.name}
                </MDBTypography>
              </div>
            </div>
            <div
              className="p-4 text-white bg-gray-500"
              style={{ boxShadow: "0px 3px 15px 1px #5C212F99" }}
            >
        ...
        <MDBCol xl="2" style={{ backgroundColor: "#5C212" }}>
          ...
          {fav
            ? fav.map((item) => (
                <TopChartsBar key={item["song_id"]} fav={item["song_id"]} />
              ))
            : null}
        </MDBCol>
      </MDBRow>
